...
func (self TableFootElement) Children() []core.Node {
...
func (self TableFootElement) GetById(id string) core.Node {
	return self.element.GetById(id)
}

func (self TableFootElement) GetByClass(classes ...string) []core.Node {
