...
func (self TableBodyElement) Children() []core.Node {
...
func (self TableBodyElement) GetById(id string) core.Node {
	return self.element.GetById(id)
}

func (self TableBodyElement) GetByClass(classes ...string) []core.Node {
