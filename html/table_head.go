...
func (self TableHeadElement) Children() []core.Node {
...
func (self TableHeadElement) GetById(id string) core.Node {
	return self.element.GetById(id)
}

func (self TableHeadElement) GetByClass(classes ...string) []core.Node {
